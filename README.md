...
Supports PHP 7.0 through current PHP releases and Illuminate 5.1 through 13. Invalid archives, missing `BabyRecords.csv` files, malformed rows, and unknown record categories now produce descriptive exceptions.
